...
# PATH; no sudo), with apt as a fallback, and links a tiny QoL config. The shared
# 03-shell-env module owns EDITOR/VISUAL and every other ~/.bashrc line. VERIFY non-destructive; INSTALL
...
log_ok "micro module done (EDITOR/VISUAL owned by 03-shell-env)"
